...
contract Diamond {
    constructor(
        ...
        bool _isAutoComp // address[] memory _earnedToAUTOPath, // address[] memory _earnedToToken0Path, // address[] memory _earnedToToken1Path, // address[] memory _token0ToEarnedPath,
    ) public payable // address[] memory _token1ToEarnedPath,
